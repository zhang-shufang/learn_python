...
class Stars:
    ...
    def _generate_star_lines(self):
        """用于产生星星队列"""
        star = Star(self)
        gap_x = star.rect.width * 3
        gap_y = star.rect.height * 3
    ...
    def _creat_stars(self, x, y, random_rate = 50):
        new_star = Star(self)
        new_star.rect.x = x + randint(-random_rate, random_rate)
        new_star.rect.y = y + randint(-random_rate, random_rate)
